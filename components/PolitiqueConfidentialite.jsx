...
const sections = [
  ...
  },
  {
    ...
    paragraphes: [
      ...
      "Si tu utilises l'assistant IA intégré à TEKÇA, le contenu de tes échanges avec l'assistant est transmis à notre prestataire d'intelligence artificielle pour générer une réponse, dans les conditions décrites ci-dessous.",
    ],
  },
  {
    titre: "Partage des données",
    paragraphes: [
      "Tes données ne sont jamais vendues. Elles peuvent être partagées avec : nos prestataires techniques (infrastructures cloud chiffrées pour l'hébergement des données et de l'application), nos prestataires de paiement (Sebpay, et les opérateurs mobile money concernés) dans la stricte mesure nécessaire au traitement d'un paiement, et notre prestataire d'intelligence artificielle pour le fonctionnement de l'assistant IA.",
  ...
  },
  {
    titre: "Mineurs",
    paragraphes: [
      "TEKÇA est accessible à partir de 14 ans. Entre 14 et 16 ans, la création de compte nécessite l'autorisation d'un représentant légal, et tout achat d'un bien physique doit être livré directement au domicile du mineur par le vendeur, sans remise en main propre à un autre endroit. Si nous prenons connaissance qu'un compte de moins de 14 ans a été créé, ou qu'un compte de 14-16 ans a été créé sans autorisation d'un représentant légal, ce compte pourra être suspendu.",
    ],
  },
  {
    titre: "Contact",
