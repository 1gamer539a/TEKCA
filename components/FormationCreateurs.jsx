...
*/
const MODULES = [
  { titreCle: "module1Titre", type: "video", duree: "12 min", gratuit: true },
  { titreCle: "module2Titre", type: "live", duree: "20 août, 19h", gratuit: true },
  { titreCle: "module3Titre", type: "pdf", duree: "8 pages", gratuit: false },
  { titreCle: "module4Titre", type: "video", duree: "18 min", gratuit: false },
];
    ...
    <div style={{ background: COLORS.background, minHeight: "100vh", color: COLORS.textPrimary }}>
      ...
      >
        ...
        <span className="text-sm font-semibold flex items-center gap-1">
          <GraduationCap size={15} color={COLORS.accentPrimary} /> {t("formationCreateurs.titreCreateurs")}
        </span>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 text-left">
                <p className="text-sm font-semibold">{t(`formationCreateurs.${m.titreCle}`)}</p>
