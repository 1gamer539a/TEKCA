...
const CLE_TYPE = { accessoire: "produits.accessoire", vetement: "produits.vetement", recharge_jeu: "produits.recharge", abonnement_service: "produits.abonnement", ebook: "produits.ebook", template: "produits.template" };
  ...
  useEffect(() => {
    ...
    const minuteur = setTimeout(async () => {
      ...
      const resProduits = (produits || []).map((p) => ({
        ...
        id: p.id,
        nom: p.nom,
        sousLibelle: CLE_TYPE[p.type] ? t(CLE_TYPE[p.type]) : p.type,
