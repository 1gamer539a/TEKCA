...
// "iPhone" et "PlayStation" sont des noms de marque — non traduits,
// comme partout ailleurs sur le site. Les autres libellés sont
// traduits à l'affichage via t("vitrine.<cle>"), voir VitrineRotative().
const VITRINE_ITEMS = [
  { cle: "baskets", Illustration: ObjetBaskets },
  { cle: null, labelBrut: "iPhone", Illustration: ObjetTelephone },
  { cle: "jeuMobile", Illustration: ObjetJeuMobile },
  { cle: null, labelBrut: "PlayStation", Illustration: ObjetManette },
  { cle: "livres", Illustration: ObjetLivre },
  { cle: "casqueGaming", Illustration: ObjetCasque },
  { cle: "abonnements", Illustration: ObjetEcran },
  { cle: "recharges", Illustration: ObjetGemme },
  { cle: "montres", Illustration: ObjetMontre },
  { cle: "sacs", Illustration: ObjetSac },
  { cle: "ordinateurs", Illustration: ObjetOrdinateur },
  { cle: "vetements", Illustration: ObjetVetement },
];
...
export function VitrineRotative({ theme, index }) {
  ...
  const label = item.cle ? t(`vitrine.${item.cle}`) : item.labelBrut;
  ...
  return (
    <div className="absolute inset-0 overflow-hidden rounded-2xl pointer-events-none" style={{ zIndex: 0 }}>
      <div key={label} className="absolute inset-0 flex flex-col items-center justify-center gap-2 takca-vitrine-entree">
