...
const sections = [
  ...
  },
  {
    titre: "Hébergement",
    paragraphes: [
      "L'application est hébergée sur des infrastructures cloud chiffrées et des serveurs hautement sécurisés, opérés par des prestataires d'hébergement privés. Ces prestataires peuvent héberger les données en dehors du territoire de la République du Congo — voir la Politique de confidentialité pour le détail des transferts de données.",
    ],
  },
  {
    ...
    paragraphes: [
      ...
      "Chaque vendeur est seul responsable de la conformité de son activité aux lois de son pays. TEKÇA n'exige aucun document administratif (RCCM, NIU, ou équivalent) pour créer un compte vendeur ou commencer à vendre sur la plateforme.",
    ],
  },
  {
