...
const QUICK_ACCESS = [
  ...
  { label: "Accessoires", icon: Gamepad2, href: "/marche?type=accessoire" },
  { label: "Vêtements", icon: Shirt, href: "/marche?type=vetement" },
  { label: "Abonnements", icon: Tv, href: "/marche?type=abonnement_service" },
  { label: "IA Assistant", icon: Sparkles, href: "/ia" },
  { label: "Événements", icon: Trophy, href: "/tournois" },
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm mt-1" style={{ color: COLORS.textMuted }}>
              Devenez vendeur agréé, lancez votre boutique.
            </p>
            <Link
              href="/vendre"
