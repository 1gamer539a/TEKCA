...
export default function Abonnements() {
  ...
  const charger = async () => {
    ...
    try {
      ...
      setErreurChargement(e.message || "Impossible de charger les abonnements.");
    } finally {
      setChargement(false);
    }
  };
      ...
      <main className="pt-20 pb-16 px-4 max-w-md mx-auto w-full">
        ...
        {chargement && (
          <div className="flex flex-col items-center justify-center gap-2 py-16">
            ...
            <p className="text-xs" style={{ color: COLORS.textMuted }}>Chargement des forfaits...</p>
          </div>
        )}
        ...
        {!chargement && erreurChargement && (
          <div className="flex flex-col items-center justify-center gap-3 py-16 text-center">
            ...
            <p className="text-sm font-semibold">Impossible de charger les abonnements</p>
