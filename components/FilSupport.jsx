  ...
  return (
    <div style={{ background: COLORS.background, minHeight: "100vh", color: COLORS.textPrimary }} className="flex flex-col">
      ...
      >
        ...
        <span className="text-sm font-semibold">{t("discussion.equipeTekca")}</span>
            ...
            {(() => {
              ...
              return url ? (
                <a href={url} target="_blank" rel="noopener noreferrer">
                  <img src={url} alt={t("discussion.pieceJointe")} className="max-w-full max-h-52 rounded-lg object-cover" />
                </a>
              ) : (
      ...
      >
        <input
          ...
          placeholder={t("discussion.ecrireMessage")}
