          ...
          return (
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  {blocageSimple?.bloque && (
                    <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full" style={{ background: COLORS.background, color: COLORS.textMuted }}>{blocageSimple.texte}</span>
                  )}
                </div>
                <p className="text-xs" style={{ color: COLORS.textMuted }}>
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  {blocageOfficiel?.bloque && (
                    <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full" style={{ background: COLORS.background, color: COLORS.textMuted }}>{blocageOfficiel.texte}</span>
                  )}
                </div>
                <p className="text-xs" style={{ color: COLORS.textMuted }}>
            ...
            <div className="flex gap-2 mt-1">
              ...
              <div className="flex-1 rounded-xl p-2.5 text-center" style={{ background: COLORS.surface, border: `1px solid ${COLORS.border}` }}>
                ...
                <p className="text-[9px] font-bold mt-1" style={{ color: COLORS.textMuted }}>FAIT POUR TOUS</p>
              </div>
            </div>
