...
export default function LeMarche() {
  ...
  useEffect(() => {
    const chargerAnnonces = async () => {
      ...
      const { data, error } = await supabase
        .from("produits")
        .select(`
          id, nom, prix_base, images, type, modes_remise, date_creation,
  ...
  const filtrees = annonces.filter((a) => {
    ...
    // dans le titre de l'annonce, pas dans le nom du vendeur.
    const matchRecherche = !q || a.titre.toLowerCase().includes(q) || a.vendeur.toLowerCase().includes(q);
