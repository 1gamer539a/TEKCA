      ...
      <div className="fixed top-14 left-0 right-0 z-30 px-4 py-2 flex flex-col gap-2" style={{ background: COLORS.background, borderBottom: `1px solid ${COLORS.border}` }}>
        ...
        <div className="flex items-center gap-2 rounded-lg px-3 py-2" style={{ background: COLORS.surface, border: `1px solid ${COLORS.border}` }}>
          ...
          <input
            ...
            placeholder="Chercher une annonce ou un vendeur..."
                    ...
                    <div className="p-2.5">
                      ...
                      {a.modesRemise?.length > 0 && (
                        <div className="flex gap-1 mb-1">
                          {a.modesRemise.includes("domicile") && <span title="Livraison à domicile" className="text-xs">📦</span>}
                          {a.modesRemise.includes("main_propre") && <span title="Remise en main propre" className="text-xs">🤝</span>}
                          {a.modesRemise.includes("instantane") && <span title="Livraison instantanée" className="text-xs">⚡</span>}
                        </div>
                      )}
