    ...
    <div style={{ background: COLORS.background, minHeight: "100vh", color: COLORS.textPrimary }}>
      ...
      >
        ...
        <span className="text-sm font-semibold flex items-center gap-1">
          <Trophy size={15} color={COLORS.accentPrimary} /> Événements
        </span>
      ...
      <main className="max-w-md mx-auto w-full px-4 pt-28 pb-10 flex flex-col gap-3">
        {chargement && (
          <p className="text-sm text-center py-16" style={{ color: COLORS.textMuted }}>Chargement des événements...</p>
        )}
        {!chargement && tournoisFiltres.length === 0 && (
          <p className="text-sm text-center py-16" style={{ color: COLORS.textMuted }}>Aucun événement pour l'instant.</p>
        )}
