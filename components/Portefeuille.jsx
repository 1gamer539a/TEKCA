  ...
  return (
    <div style={{ background: COLORS.background, minHeight: "100vh", color: COLORS.textPrimary }}>
      ...
      <main className="max-w-md mx-auto w-full px-4 pt-20 pb-10 flex flex-col gap-4">
        ...
        {transactions.length === 0 && <p className="text-xs" style={{ color: COLORS.textMuted }}>{t("wallet.aucuneTransaction")}</p>}
        {transactions.map((t) => {
          ...
          return (
            <div key={t.id} className="rounded-xl p-3 flex items-center gap-3" style={{ background: COLORS.surface, border: `1px solid ${COLORS.border}` }}>
              ...
              <div className="flex-1">
                ...
                {t.type === "transfert_envoye" && t.frais > 0 && (
                  <p className="text-[10px]" style={{ color: COLORS.textMuted }}>+ {Number(t.frais).toLocaleString()} FCFA de frais</p>
                )}
              </div>
