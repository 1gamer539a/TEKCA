    ...
    try {
      if (panneau === "recharge") {
        if (parseFloat(montant) < SEUIL_DEPOT_MIN) {
          setErreur(`Le montant minimum pour une recharge est de ${SEUIL_DEPOT_MIN.toLocaleString()} FCFA.`);
          setEnCours(false);
          return;
        }
      ...
      if (panneau === "retrait") {
        if (parseFloat(montant) < SEUIL_RETRAIT_MIN) {
          setErreur(`Le montant minimum pour un retrait est de ${SEUIL_RETRAIT_MIN.toLocaleString()} FCFA.`);
          setEnCours(false);
          return;
        }
