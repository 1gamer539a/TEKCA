...
const sections = [
  ...
  },
  {
    ...
    paragraphes: [
      "L'inscription est réservée aux personnes âgées d'au moins 14 ans. Entre 14 et 16 ans, l'inscription doit se faire avec l'autorisation d'un représentant légal.",
      "Pour tout achat d'un bien physique via Le Marché par un utilisateur âgé de 14 à 16 ans, le vendeur s'engage à livrer directement au domicile du mineur (adresse déclarée par celui-ci) plutôt qu'à convenir d'un autre lieu de remise en main propre. Cette règle ne s'applique pas aux utilisateurs de 17 ans et plus.",
  ...
  },
  {
    ...
    paragraphes: [
      ...
      "Agrégateur de paiement exclusif : l'ensemble des opérations financières — recharges (MTN Mobile Money, Airtel Money, cartes bancaires, etc.), encaissements, séquestres temporaires et retraits de fonds — sont exécutées et gérées exclusivement par notre partenaire de paiement, Sebpay (ou tout autre établissement partenaire ultérieurement désigné). Aucun fonds d'utilisateur n'est collecté ou conservé sur les serveurs ou comptes propres de TEKÇA : les sommes versées sont déposées, sécurisées et hébergées directement sur le compte marchand officiel de TEKÇA auprès de Sebpay.",
      "Affichage du solde (\"wallet\") : le solde affiché dans l'espace utilisateur de la plateforme est une représentation visuelle et comptable des crédits disponibles auprès du prestataire de paiement partenaire, reflétant en temps réel les avoirs disponibles et sécurisés sur le compte marchand central géré par Sebpay. Il ne constitue pas un dépôt bancaire ni un compte de monnaie électronique détenu par TEKÇA.",
      "Traçabilité : toutes les opérations de rechargement, de transfert et de règlement sont exécutées via les API sécurisées de Sebpay et répertoriées dans un historique inaltérable.",
  ...
  {
    titre: "Disponibilité du Service, Dysfonctionnements et Paiements",
    paragraphes: [
      "1. Nature dynamique de la plateforme et signalement des bugs. La plateforme TEKÇA est un service numérique dynamique en constante évolution. Bien que nous mettions tout en œuvre pour assurer une disponibilité maximale et une expérience optimale, TEKÇA ne garantit pas que le site ou l'application soit totalement exempt d'erreurs, de bogues, de lenteurs ou d'interruptions temporaires.",
      "L'utilisateur reconnaît que des dysfonctionnements techniques peuvent survenir. En cas de bogue, d'erreur d'affichage ou d'anomalie sur le service, l'utilisateur s'engage à ne pas exploiter la faille et à contacter immédiatement le support technique de TEKÇA à l'adresse email support@tekca.com (ou via l'espace de support dédié) afin que nos équipes puissent intervenir et résoudre le problème dans les plus brefs délais. TEKÇA ne pourra être tenue responsable des dommages directs ou indirects découlant de ces interruptions techniques temporaires.",
      "2. Services de paiement tiers (agrégateur SebPay). Toutes les transactions financières, paiements d'abonnements pro, frais de publication et achats d'options sur la plateforme TEKÇA sont exécutés et sécurisés via notre partenaire d'agrégation de paiement SebPay.",
      "Décharge de responsabilité : TEKÇA ne conserve aucune donnée bancaire ou moyen de paiement direct sur ses propres serveurs.",
      "Incidents de paiement : en cas d'échec de transaction, de double débit, de retard dans la validation d'un paiement ou de rejet de carte/Mobile Money émanant du réseau SebPay ou des opérateurs télécoms, la responsabilité de TEKÇA ne saurait être engagée.",
      "Réclamation : en cas d'anomalie liée à un règlement, l'utilisateur doit en informer le support de TEKÇA muni de sa référence de transaction, afin que nos services fassent la liaison auprès de l'agrégateur SebPay.",
    ],
  },
  {
