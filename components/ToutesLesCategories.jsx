...
const GROUPES = [
  {
    titre: "Marketplace",
    items: [
      { label: "Recharges de jeu", icon: Zap, desc: "Free Fire, PUBG, Fortnite...", href: "/marche?type=recharge_jeu" },
      { label: "Comptes & Abonnements", icon: Tv, desc: "Netflix, Spotify, Snapchat+...", href: "/marche?type=abonnement_service" },
      { label: "Accessoires PC & PlayStation", icon: Gamepad2, desc: "Manettes, casques, périphériques", href: "/marche?type=accessoire" },
      { label: "Vêtements", icon: Shirt, desc: "Catalogue et créations sur-mesure", href: "/marche?type=vetement" },
      { label: "Immobilier", icon: Home, desc: "Location/vente : maisons, appartements, terrains, bureaux", href: "/marche?type=immobilier" },
      { label: "Véhicules", icon: Car, desc: "Voitures, motos, pièces détachées", href: "/marche?type=vehicule" },
      { label: "Meuble & Déco", icon: Sofa, desc: "Mobilier maison/bureau, électroménager, aménagement", href: "/marche?type=meuble_deco" },
      { label: "Jeux & Jouets Enfants", icon: Baby, desc: "Jouets, jeux éducatifs, puériculture", href: "/marche?type=jouet_enfant" },
      { label: "Consoles & Gaming", icon: Joystick, desc: "Consoles, manettes, accessoires gaming hardware", href: "/marche?type=console_gaming" },
      { label: "High-Tech", icon: Smartphone, desc: "Téléphones, ordinateurs, informatique, TV/Son", href: "/marche?type=high_tech" },
      { label: "Mode & Beauté", icon: Gem, desc: "Vêtements, accessoires, bijoux, cosmétiques", href: "/marche?type=mode_beaute" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Événements", icon: Trophy, desc: "Compétitions gaming", href: "/tournois" },
