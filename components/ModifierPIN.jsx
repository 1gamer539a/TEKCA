...
import { ArrowLeft, Sun, Moon, Lock, Delete, CheckCircle2 } from "lucide-react";
...
export default function ModifierPIN() {
  ...
  React.useEffect(() => {
    ...
    if (etape === "confirmation" && confirmationPin.length === LONGUEUR_PIN) {
  ...
  }, [ancienPin, nouveauPin, confirmationPin, etape]);
