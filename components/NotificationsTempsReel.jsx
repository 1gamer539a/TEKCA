    ...
    const demarrer = async () => {
      ...
      const canalMessages = supabase
        ...
        .on(
          ...
          (payload) => {
            ...
            jouerSon();
            notifierNavigateur(t("divers.notifNouveauMessageTitre"), payload.new.contenu?.slice(0, 120) || t("divers.notifRecuMessage"));
          }
        )
        .subscribe();
      ...
      const canalNotifs = supabase
        ...
        .on(
          ...
          (payload) => {
            jouerSon();
            notifierNavigateur(payload.new.type === "commande" ? t("divers.notifCommandeTitre") : "TEKÇA", payload.new.texte);
          }
        )
        .subscribe();
